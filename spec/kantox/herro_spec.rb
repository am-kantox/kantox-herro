...
describe Kantox::Herro do
  ...
  it 'converts console colors to html' do
    puts str = "\e[01;38;05;21mHello\e[0m, \e[04;38;05;156mworld!\e[0m"
    expect(str.console_to_html).to eq ("<b><span style='color: #0000ff;'>Hello</span></b>, <u><span style='color: #99ff66;'>world!</span></u>")
  end
end
